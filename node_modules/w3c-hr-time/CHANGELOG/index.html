...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="shortcut icon" href="../../../_static/favicon-48x48.png"/><link rel="author" title="Sobre este documento" href="../../../about/" /><link rel="index" title="Índice" href="../../../genindex/" /><link rel="search" title="Búsqueda" href="../../../search/" />
      <link rel="canonical" href="https://python.pe/node_modules/w3c-hr-time/CHANGELOG/" />
...
<meta property="og:url" content="https://www.python.pe/node_modules/w3c-hr-time/CHANGELOG/" />
<meta property="og:site_name" content="Python Perú" />
<meta property="og:description" content="1.0.2 (2020-03-05): Do not allow infinite loops when calculating hrtime() ”s offset relative to UNIX time. (#9), Add a LICENSE file. (#3), Add Tidelift sponsorship link to README.. 1.0.1 (2018-01-0..." />
<meta property="og:image:width" content="1146" />
<meta property="og:image:height" content="600" />
<meta property="og:image" content="https://www.python.pe/_images/social_previews/summary_node_modules_w3c-hr-time_CHANGELOG_b95367da.png" />
<meta property="og:image:alt" content="1.0.2 (2020-03-05): Do not allow infinite loops when calculating hrtime() ”s offset relative to UNIX time. (#9), Add a LICENSE file. (#3), Add Tidelift spons..." />
<meta name="description" content="1.0.2 (2020-03-05): Do not allow infinite loops when calculating hrtime() ”s offset relative to UNIX time. (#9), Add a LICENSE file. (#3), Add Tidelift sponsorship link to README.. 1.0.1 (2018-01-0..." />
...
<li class="toctree-l2"><a class="reference internal" href="../../../learning-path/machine-learning-ai/">Machine Learning e IA</a></li>
  ...
  <div class="localtoc">
    ...
    <ul>
<li><a class="reference internal" href="#id1">1.0.2 (2020-03-05)</a></li>
<li><a class="reference internal" href="#id2">1.0.1 (2018-01-03)</a></li>
<li><a class="reference internal" href="#id3">1.0.0 (2018-01-02)</a></li>
</ul>
...
<section id="id1">
<h2>1.0.2 (2020-03-05)<a class="headerlink" href="#id1" title="Link to this heading">¶</a></h2>
<ul class="simple">
<li><p>Do not allow infinite loops when calculating <code class="docutils literal notranslate"><span class="pre">hrtime()</span></code>”s offset relative to UNIX time. (<a class="reference external" href="https://github.com/jsdom/w3c-hr-time/issues/9">#9</a>)</p></li>
<li><p>Add a LICENSE file. (<a class="reference external" href="https://github.com/jsdom/w3c-hr-time/issues/3">#3</a>)</p></li>
<li><p>Add Tidelift sponsorship link to README.</p></li>
</ul>
</section>
<section id="id2">
<h2>1.0.1 (2018-01-03)<a class="headerlink" href="#id2" title="Link to this heading">¶</a></h2>
<ul class="simple">
<li><p>Make <code class="docutils literal notranslate"><span class="pre">performance.toJSON()</span></code> return an object with <code class="docutils literal notranslate"><span class="pre">timeOrigin</span></code> property, per <a class="reference external" href="https://github.com/heycam/webidl/pull/505">clarifications from specification authors</a>.</p></li>
</ul>
</section>
<section id="id3">
<h2>1.0.0 (2018-01-02)<a class="headerlink" href="#id3" title="Link to this heading">¶</a></h2>
<ul class="simple">
