...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Sketchviz - Python Perú</title>
    <link rel="shortcut icon" href="../../../_static/favicon-48x48.png"/><link rel="author" title="Sobre este documento" href="../../../about/" /><link rel="index" title="Índice" href="../../../genindex/" /><link rel="search" title="Búsqueda" href="../../../search/" />
      <link rel="canonical" href="https://python.pe/node_modules/sketchviz/README/" />
...
<meta property="og:title" content="Sketchviz" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://www.python.pe/node_modules/sketchviz/README/" />
<meta property="og:site_name" content="Python Perú" />
<meta property="og:description" content="This repo is a command line clone of https://sketchviz.com/(understand: it’s a rip-off) Main features:: produce a svg from a dot file, use the latest version of GraphViz (and not Viz.js). This fixe..." />
<meta property="og:image:width" content="1146" />
<meta property="og:image:height" content="600" />
<meta property="og:image" content="https://www.python.pe/_images/social_previews/summary_node_modules_sketchviz_README_2f78c04f.png" />
<meta property="og:image:alt" content="This repo is a command line clone of https://sketchviz.com/(understand: it’s a rip-off) Main features:: produce a svg from a dot file, use the latest version..." />
<meta name="description" content="This repo is a command line clone of https://sketchviz.com/(understand: it’s a rip-off) Main features:: produce a svg from a dot file, use the latest version of GraphViz (and not Viz.js). This fixe..." />
...
<li><a class="reference internal" href="#install">Install:</a></li>
  ...
  <div class="sy-breadcrumbs-inner flex items-center">
    ...
    <ol class="flex-1" itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <strong itemprop="name">Sketchviz</strong>
    ...
    <div class="flex flex-col break-words justify-between">
      <div class="min-w-0 max-w-6xl px-6 pb-6 pt-8 xl:px-12">
        <article class="yue" role="main">
          <section class="tex2jax_ignore mathjax_ignore" id="sketchviz">
<h1>Sketchviz<a class="headerlink" href="#sketchviz" title="Link to this heading">¶</a></h1>
<p>This repo is a command line clone of <a class="reference external" href="https://sketchviz.com/">https://sketchviz.com/</a> (understand: it’s a rip-off)</p>
<section id="main-features">
<h2>Main features:<a class="headerlink" href="#main-features" title="Link to this heading">¶</a></h2>
<ul class="simple">
<li><p>produce a svg from a dot file</p></li>
<li><p>use the latest version of GraphViz (and not Viz.js). This fixes tons of issues</p></li>
<li><p>watch for file changes and update the svg automatically</p></li>
</ul>
</section>
<section id="demo">
<h2>Demo<a class="headerlink" href="#demo" title="Link to this heading">¶</a></h2>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span id="1-1"><span class="n">sketchviz</span> <span class="n">examples</span><span class="o">/</span><span class="n">clusters</span><span class="o">.</span><span class="n">dot</span> <span class="n">examples</span><span class="o">/</span><span class="n">clusters</span><span class="o">.</span><span class="n">svg</span>
</span></pre></div>
</div>
<p><img alt="" src="../../../_images/clusters.svg" /></p>
<p>If you don’t want to install it, you can also <code class="docutils literal notranslate"><span class="pre">node</span> <span class="pre">src/sketch.js</span></code>.</p>
</section>
<section id="install">
<h2>Install:<a class="headerlink" href="#install" title="Link to this heading">¶</a></h2>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span><span id="1-1">$<span class="w"> </span>git<span class="w"> </span>clone<span class="w"> </span>https://github.com/gpotter2/sketchviz.git
</span><span id="1-2">$<span class="w"> </span><span class="nb">cd</span><span class="w"> </span>sketchviz
</span><span id="1-3">$<span class="w"> </span>sudo<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>-g
</span></pre></div>
</div>
</section>
</section>
