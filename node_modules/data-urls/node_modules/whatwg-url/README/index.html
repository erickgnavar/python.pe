...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>whatwg-url - Python Perú</title>
    <link rel="shortcut icon" href="../../../../../_static/favicon-48x48.png"/><link rel="author" title="Sobre este documento" href="../../../../../about/" /><link rel="index" title="Índice" href="../../../../../genindex/" /><link rel="search" title="Búsqueda" href="../../../../../search/" />
      <link rel="canonical" href="https://python.pe/node_modules/data-urls/node_modules/whatwg-url/README/" />
...
<meta property="og:url" content="https://www.python.pe/node_modules/data-urls/node_modules/whatwg-url/README/" />
<meta property="og:site_name" content="Python Perú" />
<meta property="og:description" content="whatwg-url is a full implementation of the WHATWG URL Standard. It can be used standalone, but it also exposes a lot of the internal algorithms that are useful for integrating a URL parser into a p..." />
<meta property="og:image:width" content="1146" />
<meta property="og:image:height" content="600" />
<meta property="og:image" content="https://www.python.pe/_images/social_previews/summary_node_modules_data-urls_node_modules_whatwg-url_README_8898994a.png" />
<meta property="og:image:alt" content="whatwg-url is a full implementation of the WHATWG URL Standard. It can be used standalone, but it also exposes a lot of the internal algorithms that are usef..." />
<meta name="description" content="whatwg-url is a full implementation of the WHATWG URL Standard. It can be used standalone, but it also exposes a lot of the internal algorithms that are useful for integrating a URL parser into a p..." />
...
<li><a class="reference internal" href="#supporting-whatwg-url">Supporting whatwg-url</a></li>
  ...
  <div class="sy-breadcrumbs-inner flex items-center">
    ...
    <ol class="flex-1" itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <strong itemprop="name">whatwg-url</strong>
...
<h1>whatwg-url<a class="headerlink" href="#whatwg-url" title="Link to this heading">¶</a></h1>
...
<h2>Specification conformance<a class="headerlink" href="#specification-conformance" title="Link to this heading">¶</a></h2>
<p>whatwg-url is currently up to date with the URL spec up to commit <a class="reference external" href="https://github.com/whatwg/url/commit/43c27137a0bc82c4b800fe74be893255fbeb35f4">43c2713</a>.</p>
...
<h3>The <code class="docutils literal notranslate"><span class="pre">URL</span></code> and <code class="docutils literal notranslate"><span class="pre">URLSearchParams</span></code> classes<a class="headerlink" href="#the-url-and-urlsearchparams-classes" title="Link to this heading">¶</a></h3>
...
<h3>Low-level URL Standard API<a class="headerlink" href="#low-level-url-standard-api" title="Link to this heading">¶</a></h3>
...
<h3><code class="docutils literal notranslate"><span class="pre">whatwg-url/webidl2js-wrapper</span></code> module<a class="headerlink" href="#whatwg-url-webidl2js-wrapper-module" title="Link to this heading">¶</a></h3>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span><span id="1-1">npm install
</span></pre></div>
</div>
<p>To run tests:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span><span id="1-1">npm test
</span></pre></div>
</div>
<p>To generate a coverage report:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span><span id="1-1">npm run coverage
</span></pre></div>
</div>
<p>To build and run the live viewer:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span><span id="1-1">npm run prepare
</span><span id="1-2">npm run build-live-viewer
</span></pre></div>
</div>
...
<h2>Supporting whatwg-url<a class="headerlink" href="#supporting-whatwg-url" title="Link to this heading">¶</a></h2>
