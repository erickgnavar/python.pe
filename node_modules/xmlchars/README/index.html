...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Organization - Python Perú</title>
    <link rel="shortcut icon" href="../../../_static/favicon-48x48.png"/><link rel="author" title="Sobre este documento" href="../../../about/" /><link rel="index" title="Índice" href="../../../genindex/" /><link rel="search" title="Búsqueda" href="../../../search/" />
      <link rel="canonical" href="https://python.pe/node_modules/xmlchars/README/" />
...
<meta property="og:url" content="https://www.python.pe/node_modules/xmlchars/README/" />
<meta property="og:site_name" content="Python Perú" />
<meta property="og:description" content="Utilities for determining whether characters belong to character classes defined by the XML specs. It used to be that the library was contained in a single file and you could just import/require/wh..." />
<meta property="og:image:width" content="1146" />
<meta property="og:image:height" content="600" />
<meta property="og:image" content="https://www.python.pe/_images/social_previews/summary_node_modules_xmlchars_README_1a1fa967.png" />
<meta property="og:image:alt" content="Utilities for determining whether characters belong to character classes defined by the XML specs. It used to be that the library was contained in a single f..." />
<meta name="description" content="Utilities for determining whether characters belong to character classes defined by the XML specs. It used to be that the library was contained in a single file and you could just import/require/wh..." />
...
<li class="toctree-l2"><a class="reference internal" href="../../../learning-path/machine-learning-ai/">Machine Learning e IA</a></li>
  ...
  <div class="localtoc">
    ...
    <ul>
<li><a class="reference internal" href="#">Organization</a></li>
...
<h1>Organization<a class="headerlink" href="#organization" title="Link to this heading">¶</a></h1>
<p>It used to be that the library was contained in a single file and you could just
import/require/what-have-you the <code class="docutils literal notranslate"><span class="pre">xmlchars</span></code> module. However, that setup did not
work well for people who cared about code optimization. Importing <code class="docutils literal notranslate"><span class="pre">xmlchars</span></code>
...
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">xmlchars/xml/1.0/ed5</span></code> which covers XML 1.0 edition 5.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">xmlchars/xml/1.0/ed4</span></code> which covers XML 1.0 edition 4.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">xmlchars/xml/1.1/ed2</span></code> which covers XML 1.0 edition 2.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">xmlchars/xmlns/1.0/ed3</span></code> which covers XML Namespaces 1.0 edition 3.</p></li>
</ul>
</section>
<section id="features">
...
<li><p>“Fragments”: these are parts and pieces of regular expressions that
correspond to the productions defined in the standard that the module
covers. You’d use these to <em>build regular expressions</em>.</p></li>
<li><p>Regular expressions that correspond to the productions defined in the
standard that the module covers.</p></li>
<li><p>Lists: these are arrays of characters that correspond to the productions.</p></li>
<li><p>Functions that test code points to verify whether they fit a production.</p></li>
</ol>
</section>
